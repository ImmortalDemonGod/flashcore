...
from cultivation.scripts.flashcore.card import Card, CardState, Review
import uuid
...
@patch('cultivation.scripts.flashcore.database.duckdb.connect')
...
@patch('cultivation.scripts.flashcore.schema_manager.logger.error')
@patch('cultivation.scripts.flashcore.connection.duckdb.connect')
...
@patch('cultivation.scripts.flashcore.db_utils.db_row_to_card')
...
@patch('cultivation.scripts.flashcore.database.FlashcardDatabase._insert_review_and_get_id', side_effect=ValueError("Internal processing error"))
...
@patch('cultivation.scripts.flashcore.database.FlashcardDatabase._insert_review_and_get_id', side_effect=CardOperationError("Underlying DB issue"))
