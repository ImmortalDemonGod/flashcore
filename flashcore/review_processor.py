...
class ReviewProcessor:
    ...
    def process_review(
        ...
        try:
            ...
            latest_review_record = self.db_manager.get_latest_review_for_card(
                card.uuid
            )
            if isinstance(latest_review_record, Review):
                card.last_review_date = latest_review_record.ts.date()
