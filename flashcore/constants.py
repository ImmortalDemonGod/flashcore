...
Static FSRS (Free Spaced Repetition Scheduler) parameters.
...
# Sourced from: py-fsrs (fsrs.scheduler.DEFAULT_PARAMETERS)
...
# See FSRS documentation for parameter explanations.
